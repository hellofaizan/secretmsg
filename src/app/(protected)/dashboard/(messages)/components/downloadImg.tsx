          ...
          <div className="flex w-full flex-col gap-2">
            ...
            >
              <div className="mx-16 my-16 flex flex-col items-center justify-center">
                <div className="flex h-full flex-col gap-1 rounded-lg bg-white p-5 text-lg">
                ...
                <img
                  ...
                  alt="Banner"
                  className="-mt-[1px] w-32 rounded-bl-lg rounded-br-lg"
                />
              </div>
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="p-4">
        ...
        <div className="flex w-full flex-col gap-2">
          ...
          >
            <div className="mx-16 my-16 flex flex-col items-center justify-center">
              <div className="flex h-full flex-col gap-1 rounded-lg bg-white p-5 md:text-lg">
                <div className="flex gap-[6px]">
                  <div className="flex h-auto w-[3px] flex-none rounded-lg bg-[#e73336]" />
                  <p className="flex-1 font-normal text-black">
                    {message.content}
